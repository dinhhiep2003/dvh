        ...
        $(document).ready(function() {
            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").html("</br><h2>AI CŨNG NÓI VẬY MÀ :D</h2>");
					$("#divResult").fadeIn(2000,function()
							{
							$("#divResult2").fadeOut(0);
							$("#divResult2").html("<p>♥ ỪA THÌ TAO BIẾT TAO ĐẸP TRAI THẬT HiHi. NHƯNG THÔI TAO CŨNG ĐÀNH CHỊU THIỆT YÊU MẦY VẬY.♥ .</p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>VẬY HÃY ĐỂ TRÁI TIM Mầy THUỘC VỀ TAO MỘT LẦN NHÉ! ♥ </p></br>");
